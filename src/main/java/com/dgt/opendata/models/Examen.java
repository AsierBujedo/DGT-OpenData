...
public class Examen {
    ...
    public Examen(String nombre_autoescuela, String provincia, String seccion, Long numero_aptos, Long numero_no_aptos, Long numero_aptos_1, Long numero_aptos_2, Long numero_aptos_3o4, Long numero_aptos_mas_5) {
